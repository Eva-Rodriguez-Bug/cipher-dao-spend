...
3. **Push the code**:
   ...
   git remote add origin https://github.com/your-username/cipher-dao-spend.git
...
3. **Import Project**:
   ...
   - Choose your `cipher-dao-spend` repository
   - Click "Import"
...
| `NEXT_PUBLIC_RPC_URL` | `your_sepolia_rpc_url` | Sepolia RPC URL |
| `NEXT_PUBLIC_WALLET_CONNECT_PROJECT_ID` | `your_walletconnect_project_id` | WalletConnect Project ID |
| `NEXT_PUBLIC_INFURA_API_KEY` | `your_infura_api_key` | Infura API Key (optional) |
